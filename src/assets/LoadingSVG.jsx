		...
		!(function (t, e) {
				...
				vt = (function () {
					function t(e, n, i) {
						r(this, t),
							...
							(this.visibilityCalculator = ht(e, this.onVisibilityUpdate.bind(this))),
			...
			function pt(t) {
				...
				if (null == t.a || t.a >= 1) {
					var e = function (t) {
						...
						o = e(t.b)
					return (
						n(r) && n(i) && n(o) && ((r = r.charAt(0)), (i = i.charAt(0)), (o = o.charAt(0))),
						'#' + r + i + o
					)
				}
			...
			function Tt(t, e, n, r) {
				var i = arguments.length > 4 && void 0 !== arguments[4] && arguments[4],
					o = St(t, e, null, n, r)
				return o || (o = { x: jt(t.x, e.x, n.x, r), y: jt(t.y, e.y, n.y, r) }), i && (o.a = It(t, e, n, r)), o
			}
			function It(t, e, n, r) {
			...
			function qt(t) {
				return null != t.start && !Vt(t)
			}
			function Gt(t) {
				return null != t.end && !Vt(t)
			}
			var zt = new R()
			var Yt = {
					f: function (t) {
					...
					'#filter': function (t, e, n, r, i, o, u, a) {
						...
						var s = (function (t, e) {
							var n = (t = t.map(function (t) {
								return t && ie[t[0]]
									? (e.getElementById(t[1]), ie[t[0]](e.getElementById(t[1]), t[1], e))
									: null
							})).length
							return function (e) {
				...
				animations: [
					{
						elements: {
							eDWS6Karuqz2: {
								transform: {
									data: {
										o: { x: 235, y: 270.542005, type: 'corner' },
										t: { x: -235, y: -270.542004 },
									},
									keys: {
										s: [
											{ t: 2820, v: { x: 1, y: 1 } },
						...
						s: '',
					},
				],
				options: 'MDSAxMDgyMjk3YLTdiNjg3OTdiQMjlMNDEyOTcBzNzY2ODZiMjYlYODQ/',
			},
			'__SVGATOR_PLAYER__',
			window,
			document
		...
		<svg
			...
			<g
				...
				<text
					...
					dx='0'
					dy='0'
					fontFamily="'eDWS6Karuqz1:::Roboto'"
					fontSize='500'
					fontWeight='700'
